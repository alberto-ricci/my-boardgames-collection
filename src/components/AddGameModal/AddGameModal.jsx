...
const AddGameModal = ({
	...
	const getTitle = () => {
		...
		if (isMove) return t("add.collection.title");
		if (isCollection) return t("add.collection.title");
	...
	const unusedCategories = existingCategories.filter(
		(cat) => !form.categories.includes(cat),
	);
								...
								<div>
									...
									<div className="relative">
										<input
											...
											placeholder={t(
												"add.field.categories.placeholder",
											)}
											className={inputClass}
										/>
										{catInput && (
